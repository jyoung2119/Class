...
int main(void)
{
	int arrayOfInts1[SIZE] = {2, 6, 4, 8, 10, 12, 89, 68, 45, 37};
	int arrayOfInts2[SIZE] = {-2, -6, -4, -8, -10, -12, -89, -68, -45, -37};
	int returnAmount = 0;

	//TEST#1 LOW TO HIGH
	bubble_sort(arrayOfInts1, SIZE, low_to_high_compare);
	printf("TEST #1 Low To High: ");
	for(int i = 0; i < SIZE; i++)
	{
		printf("%i ", *(arrayOfInts1 + i));
	}
	printf("\n");
	//TEST#2 LOW TO HIGH
	bubble_sort(arrayOfInts2, SIZE, low_to_high_compare);
	printf("TEST #2 Low To High: ");
	for(int i = 0; i < SIZE; i++)
	{
		printf("%i ", *(arrayOfInts2 + i));
	}
	printf("\n\n");

	//TEST #1 HIGH TO LOW
	bubble_sort(arrayOfInts1, SIZE, high_to_low_compare);
	printf("TEST #1 High To Low: ");
	for(int i = 0; i < SIZE; i++)
	{
		printf("%i ", *(arrayOfInts1 + i));
	}
	printf("\n");
	//TEST #2 HIGH TO LOW
	bubble_sort(arrayOfInts2, SIZE, high_to_low_compare);
	printf("TEST #2 High To Low: ");
	for(int i = 0; i < SIZE; i++)
	{
		printf("%i ", *(arrayOfInts2 + i));
	}
	...
	//TEST#1 ABSOLUTE LOW TO HIGH
	bubble_sort(arrayOfInts1, SIZE, absolute_low_to_high_compare);
	printf("TEST #1 Absolute Low To High: ");
	for(int i = 0; i < SIZE; i++)
	{
		printf("%i ", *(arrayOfInts1 + i));
	}
	printf("\n");
	//TEST#2 ABSOLUTE LOW TO HIGH
	bubble_sort(arrayOfInts2, SIZE, absolute_low_to_high_compare);
	printf("TEST #2 Absolute Low To High: ");
	for(int i = 0; i < SIZE; i++)
	{
		printf("%i ", *(arrayOfInts2 + i));
	}
	...
	//TEST#1 ABSOLUTE HIGH TO LOW
	bubble_sort(arrayOfInts1, SIZE, absolute_high_to_low_compare);
	printf("TEST #1 Absolute High To Low: ");
	for(int i = 0; i < SIZE; i++)
	{
		printf("%i ", *(arrayOfInts1 + i));
	}
	printf("\n");
	//TEST#2 ABSOLUTE HIGH TO LOW
	bubble_sort(arrayOfInts2, SIZE, absolute_high_to_low_compare);
	printf("TEST #2 Absolute High To Low: ");
	for(int i = 0; i < SIZE; i++)
	{
		printf("%i ", *(arrayOfInts2+ i));
	}
