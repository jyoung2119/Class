"""
GUI portion of the project
File: breezypythongui.py
Version: 1.1
Copyright 2012, 2013 by Ken Lambert, Cengage Learning, Ltd.
website: http://home.wlu.edu/~lambertk/breezypythongui/index.html
...
subpanes in windows and dialogs .  Version 1.1 now also
runs on either Python 3.x.x or Python 2.x.x.
